...
require("josean.core.highlights")
...
require("josean.plugins.lspcolor")
...
require("josean.plugins.templateString")
require("josean.plugins.ufo")
require("josean.plugins.lualine")
require("josean.plugins.nvim-lint")
